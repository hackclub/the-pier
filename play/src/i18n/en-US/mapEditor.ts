...
const mapEditor: BaseTranslation = {
    ...
    properties: {
        ...
        linkProperties: {
            label: "Open Link",
            description: "Open website within The Pier or as a new tab.",
            linkLabel: "Link URL",
        ...
        youtubeProperties: {
            ...
            description: "Open YouTube video within The Pier or as a new tab.",
            error: "Please enter a valid YouTube URL",
            disabled: "YouTube integration is disabled.",
        },
        googleDocsProperties: {
            label: "Open Google Docs",
            description: "Open Google Docs within The Pier or as a new tab.",
            error: "Please enter a valid Google Docs URL",
            disabled: "Google Docs integration is disabled.",
        },
        klaxoonProperties: {
            label: "Open Klaxoon",
            description: "Open Klaxoon within The Pier or as a new tab.",
        ...
        googleSheetsProperties: {
            ...
            description: "Open Google Sheets within The Pier or as a new tab.",
        ...
        googleSlidesProperties: {
            ...
            description: "Open Google Slides within The Pier or as a new tab.",
        ...
        googleDriveProperties: {
            ...
            description: "Open Google Drive within The Pier or as a new tab.",
